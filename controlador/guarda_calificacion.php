...
if (isset($_POST['guardacalificacion'])) {
    ...
    $distribuidor_postulante = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["distribuidor_postulante"], ENT_QUOTES)));
    ...
    $estado_decurrente = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["estado_decurrente"] ?? NULL, ENT_QUOTES)));
    $estado_decurrente_ano = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["estado_decurrente_ano"] ?? NULL, ENT_QUOTES)));
    ...
    $telefono_legal = mysqli_real_escape_string($conn_registro, (strip_tags($_POST["telefono_legal"], ENT_QUOTES)));
