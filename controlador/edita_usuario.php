...
$sql = "UPDATE usuario SET nombre_usuario = '$nombre_usuario', apellido_usuario = '$apellido_usuario', cedula_usuario = '$cedula_usuario', perfil_id = '$perfil_id', correo_usuario = '$correo_usuario', password_usuario = '$hashPassword' WHERE id_usuario='$id_usuario' ";
